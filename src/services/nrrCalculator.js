 ...
 */
export function updateTeamAfterMatch(team, runsScored, oversPlayed, runsConceded, oversBowled, won) {
 ...
 */
export function calculateNewNRR(team, runsScored, oversPlayed, runsConceded, oversBowled) {
  const forData = parseRunsOvers(team.for);
  const againstData = parseRunsOvers(team.against);
